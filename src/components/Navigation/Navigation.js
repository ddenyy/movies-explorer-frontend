  ...
  return (
    <>
      ...
      {!autorized ? (
        ...
        <>
          <button className={`navigation__button`} type='button' onClick={handleBurgerOpen}></button>
          <nav className={`navigation navigation_type_autorized  navigation_state_${isOpenBurger ? 'open' : 'close'}`}>
          <button className={`navigation__button navigation__button_state_exit`} type='button' onClick={handleBurgerOpen}></button>
